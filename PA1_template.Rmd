...
```{r}
activity <- read.csv("/Users/yehudibaptiste/downloads/activity.csv", as.is = TRUE)
```
...
```{r, echo=TRUE}
hist(new_daily_steps$steps, main = "Histogram of total number of steps per day (with new data)", xlab = "Steps per day")
